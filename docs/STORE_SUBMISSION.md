...
- Test translation, original/translated switching, selected-text translation, SPA navigation, private browsing, settings, and the popup in current Firefox and Chrome.
...
- Explain the all-sites content script, selection context menu, provider-only host permissions, local cache, and private-browsing behavior in the AMO listing.
...
- Justify all-sites content-script access, `contextMenus`, and `unlimitedStorage`; do not request unrelated permissions.
